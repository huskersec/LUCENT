...
bench/        in-VM fixture + verification/agent kit: vuln.c, build.bat, archcheck.py,
              verify_oracle.py (oracle check), diag.py (diagnostic), run_agent_smoke.py (agent-loop smoke)
docs/         M2-runbook.md
